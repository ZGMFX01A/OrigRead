...
data class Settings(
    ...
    val autoCheckUpdates: AutoCheckUpdatesPreference = AutoCheckUpdatesPreference.default,
    ...
    val readingShare: ReadingSharePreference = ReadingSharePreference.default,
