...
sealed interface Route : NavKey {
    ...
    @Serializable data object SourceDiscovery : Route
    ...
    @Serializable data object WebsiteRules : Route

    @Serializable data object JsonRules : Route

    @Serializable data object RssHubSettings : Route

    @Serializable data object ArticleFilters : Route

    @Serializable data object TranslationSettings : Route

    @Serializable data object AiSettings : Route

    @Serializable data object ConfigurationBackup : Route

    @Serializable data object SoftwareUpdate : Route
